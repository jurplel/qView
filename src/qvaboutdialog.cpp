    ...
    ui(new Ui::QVAboutDialog)
{
    ...
    const QString labelText2 = tr("Built with Qt %1<br>Source code available under GPLv3 at <a style=\"color: #03A9F4; text-decoration:none;\" href=\"https://github.com/jurplel/qView\">Github</a><br>Icon glyph created by Guilhem from the Noun Project<br>Copyright © 2018-2019, jurplel and qView contributors").arg(QT_VERSION_STR);
